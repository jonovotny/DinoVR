...
void svd_glm(glm::mat3 A, glm::mat3 &U, glm::mat3 &S, glm::mat3 &V){
  float a11 = A[0][0];
  float a12 = A[0][1];
  float a13 = A[0][2];
  float a21 = A[1][0];
  ...
  U = glm::mat3(u11, u12, u13, u21, u22, u23, u31, u32, u33);
  S = glm::mat3(s11, s12, s13, s21, s22, s23, s31, s32, s33);
  V = glm::mat3(v11, v12, v13, v21, v22, v23, v31, v32, v33);
  U = glm::transpose(U);
  V = glm::transpose(V);
