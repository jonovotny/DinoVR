...
void svd_1(glm::mat3 A, glm::mat3 &UU, glm::mat3 &SS, glm::mat3 &VV)
{
...
void svd_2(glm::mat3 A, glm::mat3 &UU, glm::mat3 &SS, glm::mat3 &VV){
  glm::mat3 ATA = glm::transpose(A) * A;
  glm::quat qV;
  jacobiEigenanalysis(ATA, qV);
  glm::mat3 V = glm::toMat3(qV);
  glm::mat3 B = A * V;
  sortSingularValues(B, V);
  QRDecomposition(B, UU, SS);
  VV = V;
}

void svd(glm::mat3 A, glm::mat3 &UU, glm::mat3 &SS, glm::mat3 &VV){
  //A = glm::transpose(A);
  svd_2(A, UU, SS, VV);
}
